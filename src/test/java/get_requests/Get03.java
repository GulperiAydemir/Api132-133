...
public class Get03 extends JsonPlaceHolderBaseUrl {
    ...
    public void get03() {
        ...
        Note 4: If you use multiple "body()" method it will work like "Hard Assertion" .1.way
        Note 5: If you use multiple assertion in one single body() method it will work like "Soft Assertion" 2.way
         */
